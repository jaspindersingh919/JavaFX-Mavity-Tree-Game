...
public class SpinWheel2 extends Application {
    ...
    /**************************************************************
     * SpinWheel2 - constructor
     *
     * @param - int numDrops
     ************************************************************** */
    public SpinWheel2(int numDrops) {
        this.numDrops = numDrops;
    }
    
    /**************************************************************
     * start() - create the layout of page and set the scene
     *
    ...
    /**************************************************************
     * spinWheel() - animation to spin the wheel
     *
     * @param - Group wheelGroup
     * @return - void
     ************************************************************** */
    ...
    /**************************************************************
     * openNextAppleTreeWindow() - open next window
     *
    ...
    private void openNextAppleTreeWindow(Stage currentStage) {
        ...
        currentStage.close();
        AppleTree appleTree = new AppleTree(this.score, this.numDrops);
