...
public class AppleTree extends Application {
     ...
     *
     * @param - int score, int drops
     ************************************************************** */
    public AppleTree(int score, int drops) {
    ...
    /**************************************************************
     * dropApple() - drops the apple on click and add animation
     *
     * @param - MouseEvent event, ImageView appleImageView, Text appleText, int score
     * @return - void
     ************************************************************** */
    ...
    /**************************************************************
     * endGame() - ends the game and reveal the score
     *
     * @param - none
     * @return - void
     ************************************************************** */
